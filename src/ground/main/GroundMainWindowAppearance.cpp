...
void MainWindow::loadModernStyleSheet()
{
    ...
    else
    {
        state_->base_style_sheet_ =
            ...
            "QWidget#ai8TemperatureControllerPanel QLineEdit[ai8ParameterEditor=\"true\"], QWidget#ai8TemperatureControllerPanel QComboBox[ai8ParameterEditor=\"true\"], QWidget#ai8TemperatureControllerPanel QAbstractSpinBox[ai8ParameterEditor=\"true\"] { min-height: 20px; max-height: 20px; }"
