...
void MainWindow::loadModernStyleSheet()
{
    ...
    else
    {
        state_->base_style_sheet_ =
            ...
            "QWidget#ai8TemperatureControllerPanel QFrame#ai8MainContentCard { background-color: @vv-surface; border: 1px solid @vv-border; border-radius: 8px; }"
            "QWidget#ai8TemperatureControllerPanel QFrame#ai8MainContentDivider { background-color: @vv-border; border: none; min-width: 1px; max-width: 1px; }"
            ...
            "QWidget#ai8TemperatureControllerPanel QFrame#ai8DetailParametersCard { background-color: @vv-surface-alt; border: 1px solid @vv-border; border-radius: 8px; }"
