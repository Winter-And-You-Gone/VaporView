...
void MainWindow::loadModernStyleSheet()
{
    ...
    else
    {
        state_->base_style_sheet_ =
            ...
            "QScrollBar::handle:vertical { background-color: @vv-scrollbar-handle; min-height: 30px; border-radius: 6px; border: none; margin: 0px 2px 0px 2px; }"
            ...
            "QScrollBar::handle:horizontal { background-color: @vv-scrollbar-handle; min-width: 30px; border-radius: 6px; border: none; margin: 2px 0px 2px 0px; }"
            ...
            ""
            "QScrollArea#mainCardsScrollArea QScrollBar::handle:vertical, QScrollArea#mainCardsScrollArea QScrollBar::handle:horizontal { border: none; }"
