...
void MainWindow::loadModernStyleSheet()
{
    ...
    else
    {
        state_->base_style_sheet_ =
            ...
            "QSpinBox, QDoubleSpinBox { background-color: @vv-surface; border: 1px solid @vv-border; border-radius: 6px; padding: 4px 0px 4px 10px; min-height: 26px; max-height: 26px; color: @vv-text; font-size: 14px; }"
            "QSpinBox QLineEdit, QDoubleSpinBox QLineEdit { background-color: transparent; border: none; border-radius: 0px; padding: 0px; min-height: 0px; max-height: 16777215px; }"
            ...
            "QScrollArea#mainCardsScrollArea QScrollBar:vertical, QScrollArea#mainCardsScrollArea QScrollBar:horizontal { background-color: transparent; margin: 0px; }"
            ...
            "QScrollArea#mainCardsScrollArea QScrollBar::up-arrow:vertical, QScrollArea#mainCardsScrollArea QScrollBar::down-arrow:vertical, QScrollArea#mainCardsScrollArea QScrollBar::left-arrow:horizontal, QScrollArea#mainCardsScrollArea QScrollBar::right-arrow:horizontal { image: none; width: 0px; height: 0px; }"
