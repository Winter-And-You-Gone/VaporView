...
void MainWindow::loadModernStyleSheet()
{
    ...
    else
    {
        state_->base_style_sheet_ =
            ...
            "QComboBox QAbstractItemView::item:selected, QComboBox QAbstractItemView::item:selected:active, QComboBox QAbstractItemView::item:selected:!active { background-color: @vv-menu-hover; color: @vv-menu-text; }"
