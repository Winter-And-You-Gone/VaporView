...
void MainWindow::loadModernStyleSheet()
{
    ...
    else
    {
        state_->base_style_sheet_ =
            ...
            "QFrame#appSidebar { background-color: @vv-surface; border-left: none; border-top: 1px solid @vv-border; border-right: 1px solid @vv-border; border-bottom: 1px solid @vv-border; border-top-left-radius: 0px; border-top-right-radius: 8px; border-bottom-left-radius: 0px; border-bottom-right-radius: 8px; }"
