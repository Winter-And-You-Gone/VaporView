...
MainWindowState::MainWindowState()
    ...
    , epsilon_reconfigure_progress_row_(nullptr)
    , epsilon_reconfigure_progress_label_(nullptr)
    , epsilon_reconfigure_progress_bar_(nullptr)
    , epsilon_reconfigure_progress_timer_(nullptr)
    ...
    , recording_status_view_(nullptr)
    ...
    , home_temperature_overview_column_(nullptr)
    ...
    , ai8_temperature_overview_group_(nullptr)
    ...
    , data_telemetry_summary_source_pill_(nullptr)
    ...
    , ai8_temperature_overview_inline_title_lbl_(nullptr)
    ...
    , ai8_temperature_overview_panel_(nullptr)
    ...
    , log_bottom_follow_scheduled_(false)
    ...
    , epsilon_reconfigure_progress_visible_(false)
    , epsilon_reconfigure_progress_current_(0)
    , epsilon_reconfigure_progress_total_(100)
    , epsilon_reconfigure_progress_stage_()
    , is_connected_(false)
    ...
    , remote_sky_config_loaded_generation_(0)
    , remote_wave_stream_requested_(false)
    , remote_wave_stream_enable_pending_(false)
    , remote_wave_stream_auto_start_(true)
    , remote_wave_connect_after_config_read_(false)
    , remote_wave_connect_after_config_apply_(false)
    , remote_wave_pending_port_(0)
