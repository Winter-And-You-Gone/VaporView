...
QString mainCardsScrollBarBackgroundStyleSheet(bool)
{
    return QStringLiteral(
        ...
        "background-color: transparent; border: none; width: 0px; height: 0px; }"
        "QScrollArea#mainCardsScrollArea QScrollBar::up-arrow:vertical, "
        "QScrollArea#mainCardsScrollArea QScrollBar::down-arrow:vertical, "
        "QScrollArea#mainCardsScrollArea QScrollBar::left-arrow:horizontal, "
        "QScrollArea#mainCardsScrollArea QScrollBar::right-arrow:horizontal { "
...
{
    return QStringLiteral(
        "QDialog#rtkConfigDialog QGroupBox#sensorGroupBox[vaporViewTopLevelCard=\"true\"] { "
        "background-color: @vv-surface-raised; "
        ...
        "color: @vv-text; "
        "}"
        "QDialog#rtkConfigDialog QGroupBox#sensorGroupBox[vaporViewTopLevelCard=\"true\"] > QWidget#sectionTitleBar { "
        "background-color: @vv-surface-raised; "
        "border-top-left-radius: 11px; "
        "border-top-right-radius: 11px; "
        "}"
        "QDialog#rtkConfigDialog QGroupBox#sensorGroupBox[vaporViewTopLevelCard=\"true\"]::title { "
        "color: transparent; "
        "height: 0px; "
        "margin: 0px; "
        "padding: 0px; "
