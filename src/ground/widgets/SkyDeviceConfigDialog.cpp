...
QString skyDeviceConfigStyleSheet(bool dark)
{
    ...
    return applyAppThemeTokens(QStringLiteral(
        ...
        "QDialog#skyDeviceConfigDialog QComboBox QAbstractItemView { background-color: @vv-menu-panel; border: none; border-radius: 10px; color: @vv-menu-text; selection-background-color: @vv-menu-hover; selection-color: @vv-menu-text; padding: 12px 0px; outline: none; }"
