...
void CombinationNavigationPage::applyAppearance()
{
    ...
    const QString style = QStringLiteral(
        ...
        "background-color: @vv-surface; width: 8px; border: none; border-radius: 4px; margin: 0px; }"
        ...
        "background-color: @vv-surface; border-radius: 4px; }"
        ...
        "background-color: @vv-surface; border: none; height: 0px; }"
