...
QString skyDeviceConfigStyleSheet(bool dark)
{
    ...
    return QStringLiteral(
        "QDialog#skyDeviceConfigDialog { background-color: #000000; }"
        "QDialog#skyDeviceConfigDialog QScrollArea { background-color: #000000; border: none; }"
        "QDialog#skyDeviceConfigDialog QScrollArea > QWidget { background-color: #000000; }"
        "QDialog#skyDeviceConfigDialog QWidget#skyConfigContent { background-color: #000000; }"
        "QDialog#skyDeviceConfigDialog QGroupBox { background-color: #050505; border: 1px solid #2c3440; border-radius: 8px; margin-top: 0px; padding: 0px; color: #e5e7eb; }"
        "QDialog#skyDeviceConfigDialog QWidget#skyConfigGroupTitleBar { background-color: #050505; border-bottom: 1px solid #2c3440; border-top-left-radius: 7px; border-top-right-radius: 7px; }"
        ...
        "QDialog#skyDeviceConfigDialog QDoubleSpinBox { background-color: #000000; border: 1px solid #323c48; border-radius: 6px; color: #e5e7eb; selection-background-color: #245b8f; selection-color: #ffffff; }"
        ...
        "QDialog#skyDeviceConfigDialog QComboBox QAbstractItemView { background-color: #050505; border: 1px solid #323c48; color: #e5e7eb; selection-background-color: #1f3f66; selection-color: #ffffff; }"
        "QDialog#skyDeviceConfigDialog QPushButton#skyEnableToggle { background-color: #000000; color: #f87171; border: 1px solid #323c48; border-radius: 5px; padding: 0; min-width: 30px; max-width: 30px; min-height: 30px; max-height: 30px; }"
        "QDialog#skyDeviceConfigDialog QPushButton#skyEnableToggle:hover { background-color: #101010; border-color: #4b5a68; }"
        "QDialog#skyDeviceConfigDialog QPushButton#skyEnableToggle:checked { background-color: #1976d2; color: #ffffff; border-color: #1976d2; }"
        "QDialog#skyDeviceConfigDialog QPushButton#skyEnableToggle:checked:hover { background-color: #1565c0; border-color: #1565c0; }"
        "QDialog#skyDeviceConfigDialog QPlainTextEdit { background-color: #000000; color: #e5e7eb; border: 1px solid #323c48; border-radius: 8px; padding: 8px; font-family: Consolas, \"Cascadia Mono\", monospace; selection-background-color: #245b8f; selection-color: #ffffff; }"
        "QDialog#skyDeviceConfigDialog QScrollBar:vertical,"
        "QDialog#skyDeviceConfigDialog QScrollBar:horizontal { background-color: #000000; border-radius: 6px; }"
