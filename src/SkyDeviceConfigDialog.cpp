...
QString skyDeviceConfigStyleSheet(bool dark)
{
    ...
    return applyAppThemeTokens(QStringLiteral(
        ...
        "QDialog#skyDeviceConfigDialog QComboBox QAbstractItemView { background-color: #FFFEFA; border: 1px solid #E8E5DC; border-radius: 12px; color: @vv-menu-text; selection-background-color: @vv-menu-hover; selection-color: @vv-menu-text; padding: 12px 0px; outline: none; }"
        "QDialog#skyDeviceConfigDialog QComboBox QAbstractItemView::item { background-color: transparent; color: @vv-menu-text; padding: 7px 14px; min-height: 30px; border: 0px; border-bottom: 1px solid #F0EDE5; border-radius: 0px; }"
