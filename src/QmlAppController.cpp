...
QVariantMap QmlAppController::makeGnssMap(const CollectorSnapshot &collectors) const
{
    return {
        ...
        {"velNorth", current_gnss_.vel_north},
        {"velEast", current_gnss_.vel_east},
        {"velDown", current_gnss_.vel_down},
        {"heading", current_gnss_.heading},
        {"headingPitch", current_gnss_.heading_pitch},
        {"headingLength", current_gnss_.heading_length},
        {"headingType", QString::fromStdString(current_gnss_.heading_type)},
        {"headingTrackedSatellites", current_gnss_.heading_trackedsvs},
        {"headingSolutionSatellites", current_gnss_.heading_solnsvs},
        {"headingGgl1", current_gnss_.heading_ggl1},
        {"headingGgl1L2", current_gnss_.heading_ggl1l2},
        {"groundSpeed", current_gnss_.vel_ground},
        {"satellitesUsed", current_gnss_.num_satellites_used},
        {"satellitesTracked", current_gnss_.num_satellites_tracked},
        {"sigmaLat", current_gnss_.sigma_lat},
        {"sigmaLon", current_gnss_.sigma_lon},
        {"sigmaAlt", current_gnss_.sigma_alt},
        {"gdop", current_gnss_.gdop},
        {"pdop", current_gnss_.pdop},
        {"hdop", current_gnss_.hdop},
        {"htdop", current_gnss_.htdop},
        {"tdop", current_gnss_.tdop},
        {"diffAge", current_gnss_.diff_age},
        {"undulation", current_gnss_.undulation},
        {"elevationCutoff", current_gnss_.elevation_cutoff},
...
{
    return {
        {"status", QString::fromStdString(current_imu_.error_message.empty() ? (current_imu_.valid ? "OK" : "Idle") : current_imu_.error_message)},
        {"source", current_imu_.valid ? (current_imu_.from_hi83 ? "HI-83" : "HPT-900") : "-"},
        {"accX", current_imu_.acceleration[0]},
        {"accY", current_imu_.acceleration[1]},
        {"accZ", current_imu_.acceleration[2]},
        {"gyroX", current_imu_.gyroscope[0]},
        {"gyroY", current_imu_.gyroscope[1]},
        {"gyroZ", current_imu_.gyroscope[2]},
        {"roll", current_imu_.rpy[0]},
        {"pitch", current_imu_.rpy[1]},
        {"yaw", current_imu_.rpy[2]},
        {"quatW", current_imu_.quaternion[0]},
        {"quatX", current_imu_.quaternion[1]},
        {"quatY", current_imu_.quaternion[2]},
        {"quatZ", current_imu_.quaternion[3]},
        {"temperature", current_imu_.temperature},
        {"pressure", current_imu_.air_pressure},
        {"systemTimeUs", current_imu_.valid ? QString::number(current_imu_.system_time_us) : QString("-")},
        {"systemTimeMs", current_imu_.valid ? QString::number(current_imu_.system_time_ms) : QString("-")},
