...
QString AppBackend::t(const QString& key) const
{
    static const QHash<QString, QString> zh = {
        ...
        {"rtk.latency", "延迟"}, {"rtk.diagLog", "诊断日志"}, {"rtk.connected", "已连接"},
	        {"rtk.rtcmOutputConfig", "RTCM 输出配置"}, {"rtk.ggaMonitor", "GGA 监视器"},
	        {"rtk.serviceLog", "RTK 服务日志"}, {"rtk.outputPort", "输出串口"},
	        {"rtk.baudRate", "波特率"}, {"rtk.leverArm", "杆臂"},
	        {"rtk.applyLeverArm", "下发杆臂"}, {"rtk.timeoutMs", "超时 (ms)"},
	        {"rtk.reconnectMs", "重连间隔 (ms)"}, {"rtk.start", "启动"},
	        {"rtk.stop", "停止"}, {"rtk.clearLog", "清空日志"},
	        {"rtk.loadConfig", "加载配置"}, {"rtk.inputRate", "输入速率"},
	        {"rtk.outputRate", "输出速率"}, {"rtk.crcStatus", "CRC 状态"},
	        {"rtk.stopped", "已停止"}, {"rtk.statusRunning", "运行中：%1 B/s 入 / %2 B/s 出"},
	        {"rtk.ggaSourceEpsilonMain", "EPSILON 主串口"},
	        {"rtk.ggaSourceEpsilonAux", "EPSILON 从串口"},
	        {"rtk.ggaSourceAuto", "自动生成 GGA"},
        ...
        {"components.recenterSliders", "归位"}, {"components.valueFontPreview", "数值字体预览"},
        ...
        {"components.optionA", "选项 A"}, {"components.optionB", "选项 B"}, {"components.optionC", "选项 C"},
        {"components.occupiedPortCombo", "占用串口"}, {"components.mountPointCombo", "挂载点选择"},
        {"components.longButton", "长文本按钮"},
        {"components.noOptions", "无可用选项"},
        {"components.connected", "已连接"}, {"components.warning", "警告"},
        {"components.error", "错误"}, {"components.offline", "离线"}, {"components.throughput", "吞吐量"},
        {"components.latency", "延迟"}, {"components.diagLog", "诊断日志"},
        {"components.cardBodyText", "这是卡片内的正文文本。"},
        {"components.cardActionText", "带标题栏操作按钮的卡片。"}, {"components.action", "操作"},
        {"components.ntripConnected", "[信息] NTRIP 已连接"}, {"components.mountAuto", "[信息] 挂载点：AUTO"},
        {"components.rtcmActive", "[信息] RTCM 数据流已启用"}, {"components.rateExample", "[调试] 速率：1250 B/s"},
    ...
    static const QHash<QString, QString> en = {
        ...
        {"rtk.latency", "Latency"}, {"rtk.diagLog", "Diag Log"}, {"rtk.connected", "Connected"},
	        {"rtk.rtcmOutputConfig", "RTCM Output Config"}, {"rtk.ggaMonitor", "GGA Monitor"},
	        {"rtk.serviceLog", "RTK Service Log"}, {"rtk.outputPort", "Output Port"},
	        {"rtk.baudRate", "Baud Rate"}, {"rtk.leverArm", "Lever Arm"},
	        {"rtk.applyLeverArm", "Apply Lever Arm"}, {"rtk.timeoutMs", "Timeout (ms)"},
	        {"rtk.reconnectMs", "Reconnect (ms)"}, {"rtk.start", "Start"},
	        {"rtk.stop", "Stop"}, {"rtk.clearLog", "Clear Log"},
	        {"rtk.loadConfig", "Load Config"}, {"rtk.inputRate", "Input Rate"},
	        {"rtk.outputRate", "Output Rate"}, {"rtk.crcStatus", "CRC Status"},
	        {"rtk.stopped", "Stopped"}, {"rtk.statusRunning", "Running: %1 B/s in / %2 B/s out"},
	        {"rtk.ggaSourceEpsilonMain", "EPSILON Main Port"},
	        {"rtk.ggaSourceEpsilonAux", "EPSILON Aux Port"},
	        {"rtk.ggaSourceAuto", "Auto GGA"},
        ...
        {"rtk.ggaSourceOtherPort", "Other Serial Port"},
        ...
        {"components.recenterSliders", "Recenter"}, {"components.valueFontPreview", "Value Font Preview"},
        ...
        {"components.optionA", "Option A"}, {"components.optionB", "Option B"}, {"components.optionC", "Option C"},
        {"components.occupiedPortCombo", "Occupied Port"}, {"components.mountPointCombo", "Mount Point Combo"},
        {"components.longButton", "Long Button"},
        {"components.noOptions", "No options"},
        {"components.connected", "Connected"}, {"components.warning", "Warning"},
        {"components.error", "Error"}, {"components.offline", "Offline"}, {"components.throughput", "Throughput"},
        {"components.latency", "Latency"}, {"components.diagLog", "Diagnostic Log"},
        {"components.cardBodyText", "This is body text inside a card."},
        {"components.cardActionText", "Card with header action button."}, {"components.action", "Action"},
        {"components.ntripConnected", "[INFO] NTRIP connected"}, {"components.mountAuto", "[INFO] Mount: AUTO"},
        {"components.rtcmActive", "[INFO] RTCM stream active"}, {"components.rateExample", "[DEBUG] Rate: 1250 B/s"},
