...
Rectangle {
    ...
    readonly property color inactiveTone: ApplicationWindow.window.muted
    readonly property color inactiveFill: ApplicationWindow.window.secondary
    readonly property color inactiveStroke: ApplicationWindow.window.border
