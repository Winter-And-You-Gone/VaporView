...
Rectangle {
    ...
    color: "transparent"; border.width: 0; radius: 0; clip: false
    ...
    Row {
        ...
        Rectangle { id: minusButton; width: control.height; height: parent.height
            ...
            color: !control.enabled || control.value <= control.minimumValue ? ApplicationWindow.window.cardAlt : minusMouse.pressed ? ApplicationWindow.window.secondary : minusMouse.containsMouse ? ApplicationWindow.window.secondary : ApplicationWindow.window.bg
        ...
        Rectangle { id: valueArea; width: Math.max(64, control.width - control.height * 2 - 8); height: parent.height
        ...
        Rectangle { id: plusButton; width: control.height; height: parent.height
            radius: ApplicationWindow.window.uiRadius
            color: !control.enabled || control.value >= control.maximumValue ? ApplicationWindow.window.cardAlt : plusMouse.pressed ? ApplicationWindow.window.secondary : plusMouse.containsMouse ? ApplicationWindow.window.secondary : ApplicationWindow.window.bg
            border.width: ApplicationWindow.window.uiBorderWidth; border.color: ApplicationWindow.window.border
