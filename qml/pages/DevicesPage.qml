...
Item {
    ColumnLayout {
        ...
        RowLayout {
            ...
            spacing: 8
            ToolbarButton { iconName: "scan"; text: ApplicationWindow.window.t("devices.autoDetect"); variant: "primary"; onClicked: deviceBackend.autoDetectPortsOrCancel() }
            ...
            delegate: Card {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        ToolbarButton {
                            Layout.fillWidth: true
                            iconName: connected ? "unlink" : "link"
