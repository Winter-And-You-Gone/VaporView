...
int main(int argc, char** argv)
{
    ...
    require(!view->hasLocal3DTilesPreview(), QStringLiteral("buildings are not loaded at startup"));
    auto* buildings = window->findChild<QAction*>(QStringLiteral("map3DLayer_buildings3D"));
