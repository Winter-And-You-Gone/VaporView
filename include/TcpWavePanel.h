...
private:
    ...
    bool hasRemoteDataStatus() const;
    void updateRemoteStatusLabels();
    void showRemoteStatusWidgets();
    void hideRemoteStatusWidgets();
    ...
    QWidget *remote_status_widget_;
    QLabel *remote_waveform_label_;
    QLabel *remote_waveform_count_label_;
    QLabel *remote_waveform_unit_label_;
    QLabel *remote_status_separator_label_;
    QLabel *remote_peak_label_;
    QLabel *remote_peak_value_label_;
    QLabel *remote_rms_label_;
    QLabel *remote_rms_value_label_;
    QLabel *remote_search_label_;
    QLabel *remote_search_start_label_;
    QLabel *remote_search_comma_label_;
    QLabel *remote_search_end_label_;
    QLabel *remote_search_close_label_;
    QLabel *remote_index_label_;
    QLabel *remote_index_value_label_;
    QLabel *remote_feature_error_label_;
    QLabel *hint_label_;
    ...
    QString remote_waveform_count_text_;
    QString remote_peak_text_;
    QString remote_rms_text_;
    QString remote_search_start_text_;
    QString remote_search_end_text_;
    QString remote_peak_index_text_;
    ...
    bool remote_has_waveform_status_;
    bool remote_has_feature_status_;
    bool remote_feature_is_valid_;
    bool remote_has_search_status_;
    bool remote_search_end_is_terminal_;
